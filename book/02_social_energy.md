# Chapter 2. The Social Energy Economy
...
**1. How one gains energy.** The sources from which a person's supply of social energy is
replenished, and the rate at which each replenishes it. For some, energy comes from being among
others and is spent by being alone; for others the reverse; for many it depends on the kind of
company and the kind of solitude. We record the sources and their yield, not a single
introvert-extrovert label, because the same person can gain from one kind of contact and lose
from another.

**2. Where energy is spent.** Given a supply, which social interactions a person chooses to
enter. People with similar supplies spend them very differently: one invests in a few deep
relationships, another spreads across many shallow ones, a third spends almost nothing socially
